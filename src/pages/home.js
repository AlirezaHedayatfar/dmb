...
export async function renderHomePage (request, env, proxySettings, isPassSet) {
    ...
    <head>
        ...
        <title>DMB Panel ${panelVersion}</title>
    ...
    <body>
        <h1>DMB Panel <span style="font-size: smaller;">${panelVersion}</span> 💦</h1>
        <div class="form-container">
            ...
            <div class="table-container">
                <table id="normal-configs-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ${subQR('sub', '', 'DMB-Normal', 'Normal Subscription')}
                            ${subURL('sub', '', 'DMB-Normal')}
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="table-container">
                <table id="full-normal-configs-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ${subQR('sub', 'xray', 'DMB-Full-Normal', 'Full normal Subscription')}
                            ${subURL('sub', 'xray', 'DMB-Full-Normal')}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${subQR('sub', 'sfa', 'DMB-Full-Normal', 'Full normal Subscription', true)}
                            ${subURL('sub', 'sfa', 'DMB-Full-Normal')}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${subQR('sub', 'clash', 'DMB-Full-Normal', 'Full normal Subscription')}
                            ${subURL('sub', 'clash', 'DMB-Full-Normal')}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ${subQR('fragsub', '', 'DMB-Fragment', 'Fragment Subscription')}
                            ${subURL('fragsub', '', 'DMB-Fragment')}
                        </td>
                    </tr>
                    <tr>
                        <td style="text-wrap: nowrap;">
                        ...
                        <td>
                            ${subQR('fragsub', 'hiddify', 'DMB-Fragment', 'Fragment Subscription')}
                            ${subURL('fragsub', 'hiddify', 'DMB-Fragment')}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="table-container">
                <table id="normal-configs-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ${subQR('warpsub', 'xray', 'DMB-Warp', 'Warp Subscription')}
                            ${subURL('warpsub', 'xray', 'DMB-Warp')}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${subQR('sub', 'singbox', 'DMB-Warp', 'Warp Subscription', true)}
                            ${subURL('warpsub', 'singbox', 'DMB-Warp')}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${subQR('warpsub', 'clash', 'DMB-Warp', 'Warp Subscription')}
                            ${subURL('warpsub', 'clash', 'DMB-Warp')}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="table-container">
                <table id="warp-pro-configs-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ${subQR('warpsub', 'nikang', 'DMB-Warp-Pro', 'Warp Pro Subscription')}
                            ${subURL('warpsub', 'nikang', 'DMB-Warp-Pro')}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${subQR('warpsub', 'hiddify', 'DMB-Warp-Pro', 'Warp Pro Subscription', true)}
                            ${subURL('warpsub', 'hiddify', 'DMB-Warp-Pro')}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="footer">
                ...
                <a class="link" href="https://github.com/bia-pain-bache/DMB-Worker-Panel" style="color: var(--color); text-decoration: underline;" target="_blank">Github</a>
